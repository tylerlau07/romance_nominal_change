...
f1Sg_endings <- max_endings$f1Sg
f1Pl_endings <- max_endings$f1Pl
...
m2Sg_endings <- max_endings$m2Sg
m2Pl_endings <- max_endings$m2Pl
n2Sg_endings <- max_endings$n2Sg
n2Pl_endings <- max_endings$n2Pl
...
# nPl, fSg
nPlfSg_equal <- !is.na(mapply(all.equal, n2Pl_endings, f1Sg_endings, SIMPLIFY = FALSE) == TRUE)
print(paste0("nPl and fSg fully match ", sum(nPlfSg_equal)/length(nPlfSg_equal)*100, "% of the time"))
print(paste("Endings that overlap are", paste(n2Pl_endings[nPlfSg_equal], collapse = ","), "in trials", paste(names(n2Pl_endings[nPlfSg_equal]), collapse = ",")))
# nPl, fPl
nPlfPl_equal <- !is.na(mapply(all.equal, n2Pl_endings, f1Pl_endings, SIMPLIFY = FALSE) == TRUE)
print(paste0("nPl and fPl fully match ", sum(nPlfPl_equal)/length(nPlfPl_equal)*100, "% of the time"))
print(paste("Endings that overlap are", paste(n2Pl_endings[nPlfPl_equal], collapse = ","), "in trials", paste(names(n2Pl_endings[nPlfPl_equal]), collapse = ",")))

# mPl, fSg
mPlfSg_equal <- !is.na(mapply(all.equal, m2Pl_endings, f1Sg_endings, SIMPLIFY = FALSE) == TRUE)
print(paste0("mPl and fSg fully match ", sum(mPlfSg_equal)/length(mPlfSg_equal)*100, "% of the time"))
print(paste("Endings that overlap are", paste(m2Pl_endings[mPlfSg_equal], collapse = ","), "in trials", paste(names(m2Pl_endings[mPlfSg_equal]), collapse = ",")))
# mPl, fPl
mPlfPl_equal <- !is.na(mapply(all.equal, m2Pl_endings, f1Pl_endings, SIMPLIFY = FALSE) == TRUE)
print(paste0("mPl and fPl fully match ", sum(mPlfPl_equal)/length(nPlfPl_equal)*100, "% of the time"))
print(paste("Endings that overlap are", paste(m2Pl_endings[mPlfPl_equal], collapse = ","), "in trials", paste(names(m2Pl_endings[mPlfPl_equal]), collapse = ",")))
