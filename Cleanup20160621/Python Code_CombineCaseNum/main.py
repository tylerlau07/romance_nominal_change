...
def conductGeneration(generation, corpus, previous_output):
        ...
        for (form, input_tuple, expected_output) in training_corpus.test:                 
                ...
                dec = constants.tup_to_dec[tuple(result[constants.dec_b:constants.casenum_b])]
                ...
                form.output_change[generation] = (gender, dec, casenum[0:3], casenum[3:], output)
...
for lemma in corpus:
        ...
        for case, form in lemma.cases.iteritems():
                ...
                expected_outputs[form.lemmacase] = (
                        ...
                        constants.outputs[form.casenum]
                )
