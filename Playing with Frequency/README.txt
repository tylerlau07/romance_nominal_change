...
This is the revised implementation of Lau (2016), playing around with frequency
...
**************
**************
Following Parameters may be turned on or off:

Token Frequency: logged frequencies of individual lexical items
Type Frequency: case/number frequencies
